...
@Repository
public class ResourceDaoImpl extends PageDaoImpl implements ResourceDao {
    @Autowired
    ...
    public Resource findOne(Long resourceId) {
        ...
        List<Resource> resourceList = jdbcTemplate.query(sql, BeanPropertyRowMapper.newInstance(Resource.class), resourceId);
    ...
    public List<Resource> findAll() {
        ...
        return jdbcTemplate.query(sql, BeanPropertyRowMapper.newInstance(Resource.class));
    }

	@Override
	public List<Resource> findMenus(Long parent_id) {
		String sql = "select id, name, type, url, permission, parent_id, parent_ids, available from sys_resource where parent_id=? order by concat(parent_ids, id) asc";
        return jdbcTemplate.query(sql, BeanPropertyRowMapper.newInstance(Resource.class), parent_id);
	}
